...
const products = [

  {
    ...
    // image: '/src/assets/Monoverse/tile000.png',
    image: 'https://github.com/Kora-Interactive/Kora-Interactive/blob/main/src/assets/Monoverse/tile000.png',
    rating: 4.8,
    downloads: '1k+',
    status: 'Live',
    accent: 'green',
    ...
    image: '/src/assets/MamaPutt/MamaPutt.png',
    rating: 4.7,
    downloads: '500+',
    status: 'Alpha',
    accent: 'yellow',
  ...
  },
  {
    ...
    image: '/src/assets/UrbanConquest/Urban Conquest.jpeg',
    rating: 0,
    downloads: 'NAN',
    status: 'Coming',
    accent: 'red',
