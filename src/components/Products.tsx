...
const products = [

  {
    ...
    image: 'https://res.cloudinary.com/drrkmnmct/image/upload/v1768153058/Monoverse_eb6sxd.png',
  ...
  },
  {
    ...
    image: 'https://res.cloudinary.com/drrkmnmct/image/upload/v1768153058/Teasuremania_ud7saq.jpg',
    rating: 0,
    downloads: 'NAN',
    status: 'Coming',
    accent: 'red',
    ...
    {
    title: 'AFRO GT',
    category: 'Arcade Mobile Car Race Experience',
    description: 'Get into a world of african racing and celebrity car battle experiences.',
    image: 'https://res.cloudinary.com/drrkmnmct/image/upload/v1768156226/AfroGT_ww8qkm.png',
    rating: 0,
    downloads: 'NAN',
    status: 'Coming',
    accent: 'red',
    ...
    category: 'Open World Mafia Game Experience',
    description: 'Running guns and drugs through a delivery company, you have to pay up or answer to thr mafia.',
    image: 'https://res.cloudinary.com/drrkmnmct/image/upload/v1768419345/ChatGPT_Image_Jan_14_2026_08_29_28_PM_d6hr6w.png',
    rating: 0,
    downloads: 'NAN',
    status: 'Coming',
    accent: 'red',
  },
  {
    ...
    image: 'https://res.cloudinary.com/drrkmnmct/image/upload/v1768153057/Urban_Conquest_ngtsba.jpg',
    rating: 0,
    downloads: 'NAN',
    status: 'Coming',
    accent: 'red',
